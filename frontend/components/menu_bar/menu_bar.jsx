              ...
              {this.state.open && (
                <div className="dropdown">
                  <ul>
                    ...
                    <li>
                      <Link to={`/songs/new`}>Edit profile</Link>
                    </li>
                    <li>
                      <Link to={`/songs/new`}>Upload songs</Link>
                    </li>
                    <li>
                      <Link to={`/albums/new`}>Upload albums</Link>
                    </li>
      ...
      pageContent = (
        <div className="menu-bar">
          ...
          <ul className="menu-bar-bottom">
            <li>
              Discover amazing new music and <span>directly support</span> the
              artists who make it.
            </li>
            <li>
